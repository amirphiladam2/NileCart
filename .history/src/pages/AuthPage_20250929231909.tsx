...
const AuthPage = () => {
  ...
  const [signupForm, setSignupForm] = useState({ email: '', password: '', confirmPassword: '', name: '', role: 'buyer' });
          ...
          <Card className="mt-4 border-green-200 bg-green-50">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-green-700 mb-4">
                Your account has been successfully verified. You can now sign in to start shopping.
              </p>
              <Button 
